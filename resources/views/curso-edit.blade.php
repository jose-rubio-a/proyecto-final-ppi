...
<html lang="es">
    ...
    <body>
        ...
        <h1 style="text-align: center;">Editar curso: {{ $curso-> nombre}}</h1>
                        ...
                        <div class="card mb-5">
                            <div class="card-body d-flex flex-column align-items-center">
                                <form class="text-center" method="post" action="{{ route('curso.update', $curso) }}">
                                    ...
                                    @enderror
                                    <div class="mb-3"><textarea class="form-control" name="informacion" placeholder="Informacion" rows="10" cols="30">{{ $curso->informacion }}</textarea></div>
                                    @error('informacion')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
