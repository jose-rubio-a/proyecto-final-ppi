            ...
            <div class="card d-lg-flex justify-content-lg-center" style="width: 80%;background: rgb(255,255,253);">
                <div class="card-body">
                    <form method="post" action="{{ route('publicacion.store') }}" enctype="multipart/form-data">
                        ...
                        <input class="form-control d-flex" type="text" style="width: 75%;" name="nombre" placeholder="Nombre">
                        @error('nombre')
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input class="form-control" type="number" style="width: 100%;" name="precio" step="any" placeholder="0.00">
                                @error('precio')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
