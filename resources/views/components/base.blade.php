...
<html data-bs-theme="light" lang="es">
    ...
    <head>
        ...
        <title>Proyecto_CRUD</title>
        <link rel="stylesheet" href="{{ asset('pagina/bootstrap/css/bootstrap.min.css')}}">
        <link rel="stylesheet" href="{{ asset('pagina/css/Login-Form-Basic-icons.css')}}">
    </head>

    <body>
    <div class="row" style="max-width: 100%;max-height: 100%;min-height: 100%;">
        <div class="col-sm-1" style="width: 82px;max-width: 82px;min-width: 82px;" style="z-index: 0;">
            <div class="bg-body shadow d-flex flex-column flex-shrink-0 position-fixed top-0 bottom-0" style="width: 4.5rem;">
                <a class="text-center link-body-emphasis d-block p-3 text-decoration-none border-bottom" href="{{ route('publicacion.index') }}" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Icon-only">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bag-fill" style="font-size: 25px;">
                ...
                <ul class="nav nav-pills flex-column text-center nav-flush mb-auto">
                    <li class="nav-item">
                        <a class="nav-link active link-light py-3 border-bottom rounded-0" href="{{ route('publicacion.index') }}" aria-current="page">
                    ...
                    <li class="nav-item">
                        <a class="nav-link py-3 border-bottom rounded-0" href="{{ route('publicacion.create') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-plus-square-dotted" style="font-size: 15px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link py-3 border-bottom rounded-0" href="{{ route('dashboard') }}">
        ...
        <div class="col" style="width: 65%;" style="z-index: 1;">
            {{ $slot }}
        </div>
    </div>
