...
<html data-bs-theme="light" lang="es">
    ...
    <header class="d-flex d-lg-flex justify-content-center justify-content-lg-center" style="width: 100%;">
        <div class="row d-md-flex justify-content-md-start" style="width: 100%;">
            <div class="col-md-1 d-flex d-sm-flex d-md-flex justify-content-center align-items-center align-items-sm-center justify-content-md-center align-items-md-center" style="width: 20%;"><button class="btn btn-primary d-flex justify-content-center align-items-center" data-bss-hover-animate="pulse" type="button" data-bs-target="#offcanvas-menu" data-bs-toggle="offcanvas" style="width: 50px;height: 50%;min-width: 30px;max-width: 50px;min-height: 30px;max-height: 50px;background: var(--bs-gray-400);border-width: 0px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-list" style="width: 100%;height: 100%;filter: invert(100%);transform: scale(1.37);">
                        <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"></path>
                    </svg></button></div>
            <div class="col d-flex d-md-flex justify-content-center align-items-center justify-content-md-center" style="width: 80%;"><a href="/"><img src="{{asset('/storage/img/Diseno_sin_titulo.png')}}" style="width: 150px;"></a></div>
            @if (Route::has('login'))
                @auth
                <div class="col-md-1 d-flex d-sm-flex d-md-flex justify-content-center align-items-center align-items-sm-center justify-content-md-center align-items-md-center" style="width: 20%;"><button class="btn btn-primary d-flex justify-content-center align-items-center" data-bss-hover-animate="pulse" type="button" style="width: 50px;height: 50px;min-width: 30px;max-width: 50px;min-height: 30px;max-height: 50px;background: var(--bs-body-bg);border-width: 0px;margin-right: 10%;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cart" style="backdrop-filter: invert(100%);filter: invert(100%);width: 100%;height: 100%;transform: scale(1.37);">
        ...
        <div class="offcanvas-body d-flex flex-column justify-content-between pt-0">
            <div>
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li class="nav-item">
                            <a class="nav-link link-body-emphasis" href="#" data-bs-target="#offcanvas-menu-1" data-bs-toggle="offcanvas"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-speedometer2 me-2">
    ...
    <div id="offcanvas-menu-1" class="offcanvas offcanvas-start bg-body" tabindex="-1" data-bs-backdrop="false">
        <div class="offcanvas-body d-flex flex-column justify-content-between pt-0">
            <div style="margin-top: 10px;">
                <hr class="mt-0" />
                <ul class="nav nav-pills flex-column mb-auto">
                    <li class="nav-item"><a class="nav-link active link-light" href="#" aria-current="page" data-bs-target="#offcanvas-menu" data-bs-toggle="offcanvas"><svg class="bi bi-chevron-double-left me-2" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
