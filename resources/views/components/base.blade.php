            ...
            <div>
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li class="nav-item"><a class="nav-link link-body-emphasis" href="{{ route('publicacion.create') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-grid me-2">
        ...
        <div class="offcanvas-body d-flex flex-column justify-content-between pt-0">
            <div style="margin-top: 10px;">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li class="nav-item"><a class="nav-link link-body-emphasis" href="{{ route('temporada.index') }}"> Mostrar Todo </a></li>
